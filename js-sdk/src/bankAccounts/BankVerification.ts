import {
    ...
    BankAccountVerificationIdResponse, CreateBankAccountVerificationElementOptions, BankAccountVerificationElement
} from '@/types'
...
export class PublicSquareBankVerification {
    ...
    public openVerification(
        target ?: string, onVerificationComplete ?: (verificationId: string) => void
    )
    ...
    public async saveBankAccountVerification(request: BankAccountVerificationIdRequest):
        Promise<BankAccountVerificationIdResponse> {
