import type { CardCreateInput, ValidatedCardsCreateInput } from '@/types/sdk/cards';

export function validateCreateCardInput(input: CardCreateInput): ValidatedCardsCreateInput {
