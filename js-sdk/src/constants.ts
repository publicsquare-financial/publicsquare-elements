...
const ELEMENTS_PUBLICSQUARE_APPLE_PAY_NO_POINTER_MESSAGE =
  'PublicSquareApplePay requires psqPointer when initializing'

const ELEMENTS_PUBLICSQUARE_GOOGLE_PAY_NO_POINTER_MESSAGE =
  'PublicSquareGooglePay requires psqPointer when initializing'
